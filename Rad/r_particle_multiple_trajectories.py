...
filebase = '/Users/Anton/Desktop/Data/Binaries/radiative_particle'
files = [filebase + '_1000_10_10_dt10.npy',
        filebase + '_1000_10_20_dt10.npy',
        filebase + '_1000_69_70_dt10.npy',
        filebase + '_1000_60_90_dt10.npy']
...
for i in range(0,len(loadedFiles)):
    ...
    norm = matplotlib.colors.Normalize(5.e-4,4e-1)
    ...
    plt.arrow(mCOORD[-1,0],mCOORD[-1,1],mCOORD[-1,0]-mCOORD[-3,0],mCOORD[-1,1]-mCOORD[-3,1], 
...
colorbar = plt.colorbar(lc, ticks=np.linspace(0,0.4,9), cax=cax)
plt.sca(ax)


c = plt.contourf(grid_x, grid_y, np.log10(grid_rho*6.17e15), extend='both', levels=np.linspace(-10,-3,75), cmap='gray', alpha=0.99)
colorbar2 = plt.colorbar(c, ticks=np.linspace(-10,-3,8).astype(int))
...
legend = plt.legend(handles=[p1,p2,p3,p4,p5,p6,p7], fontsize='small',loc='lower right', bbox_to_anchor=(1, 0.01))
legend.draw_frame(False)

plt.show()
plt.savefig('/Users/Anton/Dropbox/Aleksander/Figures/simavg0100-0189/particles/three_particles', bbox_inches='tight') 
